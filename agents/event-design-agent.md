...
Tool-agnostic definition. Defines domain event schemas, naming, and retry/DLQ policy from an approved DDD model. Sixth-stage agent in the kart-platform pipeline (`docs/PLATFORM_BLUEPRINT.md` §8.2 #6). Use after a service's ddd-model.md is approved.
