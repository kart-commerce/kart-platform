...
Tool-agnostic definition. Produces the OpenAPI/gRPC contract for a service from its approved DDD model. Fourth-stage agent in the kart-platform pipeline (`docs/PLATFORM_BLUEPRINT.md` §8.2 #4). Use after a service's ddd-model.md is approved.
