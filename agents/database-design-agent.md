...
Tool-agnostic definition. Designs write (PostgreSQL) and read (MongoDB/cache) schemas from an approved DDD model. Fifth-stage agent in the kart-platform pipeline (`docs/PLATFORM_BLUEPRINT.md` §8.2 #5). Use after a service's ddd-model.md is approved.
